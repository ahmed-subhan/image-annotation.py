...
hight_label_position = (arrow_start[0] - 150, (arrow_start[1] + arrow_end[1]) // 2)
cv2.putText(image_rgb, f'Hight: {hight}px', hight_label_position, font, 0.8, (255, 255, 0), 2, cv2.LINE_AA)


plt.figure(figsize=(12, 8))
plt.imshow(image_rgb)
plt.title('Annotated image with regions, centers, and bi-directional hight arrow')
plt.axis('off')
plt.show()